...
var notesModel_1 = __importDefault(require("../models/notesModel"));
var user = _1.sampleData.user, notes = _1.sampleData.notes;
var MONGO_URI = config_1.config.MONGO_URI;
mongoose_1.default.connect("" + MONGO_URI, { useNewUrlParser: true, useCreateIndex: true, useUnifiedTopology: true })
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.sent();
                return [4 /*yield*/, notesModel_1.default.deleteMany({})];
            case 2:
                _a.sent();
                return [4 /*yield*/, userModel_1.default.create(user)];
            case 3:
                _a.sent();
                return [4 /*yield*/, notesModel_1.default.create(notes)];
            case 4:
                _a.sent();
